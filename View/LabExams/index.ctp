<div class="labExams index">
	<h2><?php echo __('Lab Exams'); ?></h2>
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $labExam['LabExam']['id']), null, __('Are you sure you want to delete # %s?', $labExam['LabExam']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
