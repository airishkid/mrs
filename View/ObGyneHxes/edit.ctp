...
<?php echo $this->Form->create('ObGyneHx'); ?>
	<fieldset>
		<legend><?php echo __('Edit Ob Gyne Hx'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ObGyneHx.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ObGyneHx.id'))); ?></li>
