<div class="clinicalHistories index">
	<h2><?php echo __('Clinical Histories'); ?></h2>
	...
	<tr>
		<td><?php echo h($clinicalHistory['ClinicalHistory']['id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($clinicalHistory['Patient']['id'], array('controller' => 'patients', 'action' => 'view', $clinicalHistory['Patient']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $clinicalHistory['ClinicalHistory']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $clinicalHistory['ClinicalHistory']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $clinicalHistory['ClinicalHistory']['id']), null, __('Are you sure you want to delete # %s?', $clinicalHistory['ClinicalHistory']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
